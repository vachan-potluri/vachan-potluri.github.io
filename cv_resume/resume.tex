...
\begin{itemize}
	...
	\begin{itemize}
		\item \highlight{Developed a solver} \plens{} implementing a DG subcell limiter using \dealii{} C++ FEM library
	...
	\begin{itemize}
		...
		\item \highlight{Introduced a new solver} \apupfrk{} to implement \apup{} flux scheme along with TVD-RK3 time integration method
		\item \highlight{Presented a comparative study} of these two solvers by performing simulations of several 1D and 2D test cases to identify vulnerabilities of the flux schemes\\
