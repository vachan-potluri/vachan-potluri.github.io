...
\begin{itemize}
	...
	\begin{itemize}
            \item \highlight{Implemented segregated Riemann solver} to extend high speed capabilities of the PISO and SIMPLE algorithms
            \item \highlight{Proposed and tested optimisation to real gas mixing models} among other software enhancement and review tasks
	\end{itemize}
